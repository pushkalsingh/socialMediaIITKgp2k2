...
function DeleteButton({ disabled }: { disabled: boolean }) {
  return (
    <button
      ...
      className="text-sm px-3 py-2 rounded-md border border-red-200 text-red-600 transition-all duration-150 hover:bg-red-50 hover:shadow-sm active:scale-95 dark:border-red-900 dark:text-red-400 dark:hover:bg-red-950 disabled:opacity-40 disabled:cursor-not-allowed"
    >
      Delete
    </button>
  );
